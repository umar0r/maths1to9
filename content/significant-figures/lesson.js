(() => {
    ...
    const slug = 'significant-figures';
    ...
    function guidedHtml(slide) {
        ...
        const places = {'6':'millions','5':'hundred-thousands','4':'ten-thousands','3':'thousands','2':'hundreds','1':'tens','0':'ones','-1':'tenths','-2':'hundredths','-3':'thousandths','-4':'ten-thousandths','-5':'hundred-thousandths','-6':'millionths'};
        ...
        const prompt = step === 0 ? 'Start at the first non-zero digit. Tap the last significant figure you need to keep.' : step === 1 ? 'Now tap the digit right after it.' : 'Will that next digit make us round up? Choose your answer.';
